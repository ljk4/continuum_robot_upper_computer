...
#define OLED_IIC_SDA_Read()   GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_9)

#define OLED_IIC_SDA_Out() 	{GPIOB->MODER&=~(3<<(9*2));GPIOB->MODER|=1<<(9*2);} //PB9输出模式
#define OLED_IIC_SDA_In()	{GPIOB->MODER&=~(3<<(9*2));GPIOB->MODER|=0<<(9*2);}	//PB9输入模式
